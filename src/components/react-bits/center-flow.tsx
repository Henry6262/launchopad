...
export interface NodeItem {
  /** Content to render inside the node (JSX, icons, images, etc.) */
  content?: ReactNode;
}

export interface CenterFlowProps {
  /** Array of node items - each can contain custom content (JSX, icons, images, etc.) */
  nodeItems?: NodeItem[];
  /** Content to render in the center node */
...
const DEFAULT_NODE_ITEMS: NodeItem[] = Array.from({ length: 8 }, () => ({}));
...
const CenterFlow: React.FC<CenterFlowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div ref={glowRef} className="center-flow-center" style={centerStyle}>
